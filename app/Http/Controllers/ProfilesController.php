    ...
    */
    ...
    public function show($username)
    {
        ...
        try {
            ...
            $displayusername    = ($user->name === $user->nip) ? ((is_null($user->first_name)) ? ($user->name) : ($user->first_name)) : (((is_null($user->name)) ? ($user->nip) : ($user->name)));
            $access;
    ...
    public function update($username, Request $request)
    {
        ...
        return redirect('profile/'.$user->nama.'/edit')->with('status', 'Profile updated!');
