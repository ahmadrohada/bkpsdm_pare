...
use App\Models\RealisasiIndikatorSubKegiatanTahunan;
...
class RealisasiKegiatanSKPTahunanAPIController extends Controller {
    ...
    public function AddRealisasiKegiatanSKPTahunan(Request $request)
    {
        ...
        $x = IndikatorSubKegiatan::
                            //to subkegiatan renja
                            leftjoin('db_pare_2018.renja_subkegiatan AS renja_subkegiatan', function($join) {
                                $join   ->on('renja_indikator_subkegiatan.subkegiatan_id','=','renja_subkegiatan.id');
                            })
                            ->leftjoin('db_pare_2018.skp_tahunan_kegiatan AS kegiatan_skp_tahunan', function($join) {
                                $join   ->on('kegiatan_skp_tahunan.subkegiatan_id','=','renja_subkegiatan.id');
                            })
                            //REALISASINYA
                            ->leftjoin('db_pare_2018.realisasi_indikator_subkegiatan_tahunan AS realisasi_indikator', function($join) use($capaian_id) {
                                $join   ->on('realisasi_indikator.indikator_subkegiatan_id','=','renja_indikator_subkegiatan.id');
                                $join   ->WHERE('realisasi_indikator.capaian_id','=', $capaian_id );
                            })
                            ->leftjoin('db_pare_2018.realisasi_subkegiatan_tahunan AS realisasi_subkegiatan', function($join) use($capaian_id) {
                                $join   ->on('realisasi_subkegiatan.subkegiatan_id','=','renja_subkegiatan.id');
                                $join   ->WHERE('realisasi_subkegiatan.capaian_id','=', $capaian_id );
                            })
                
                            ->SELECT(       'renja_subkegiatan.id AS subkegiatan_id',
                                            'renja_indikator_subkegiatan.id AS ind_subkegiatan_id',
                                            'renja_indikator_subkegiatan.label AS indikator_label',
                                            'renja_indikator_subkegiatan.target AS indikator_quantity',
                                            'renja_indikator_subkegiatan.satuan AS indikator_satuan',

                                            'renja_subkegiatan.id AS subkegiatan_id',
                                            'renja_subkegiatan.label AS subkegiatan_label',
                                            'renja_subkegiatan.quality AS subkegiatan_quality',
                                            'renja_subkegiatan.cost AS subkegiatan_cost',
                                            'renja_subkegiatan.target_waktu AS subkegiatan_target_waktu',
                                            'renja_subkegiatan.angka_kredit AS subkegiatan_ak',
                                            ...
                                            'realisasi_subkegiatan.id AS realisasi_subkegiatan_id',
                                            'realisasi_subkegiatan.target_angka_kredit AS realisasi_subkegiatan_target_ak',
                                            'realisasi_subkegiatan.target_quality AS realisasi_subkegiatan_target_quality',
                                            'realisasi_subkegiatan.target_cost AS realisasi_subkegiatan_target_cost',
                                            'realisasi_subkegiatan.target_waktu AS realisasi_subkegiatan_target_waktu',
                                            'realisasi_subkegiatan.realisasi_angka_kredit AS realisasi_subkegiatan_realisasi_ak',
                                            'realisasi_subkegiatan.realisasi_quality AS realisasi_subkegiatan_realisasi_quality',
                                            'realisasi_subkegiatan.realisasi_cost AS realisasi_subkegiatan_realisasi_cost',
                                            'realisasi_subkegiatan.realisasi_waktu AS realisasi_subkegiatan_realisasi_waktu'
                            ...
                            ->WHERE('renja_indikator_subkegiatan.id', $indikator_subkegiatan_id)
                            ->first();

       
        $jm_indikator = IndikatorSubKegiatan::WHERE('subkegiatan_id',$x->subkegiatan_id)->count();


        $ind_subkegiatan = array(
            'ind_subkegiatan_id'        => $x->ind_subkegiatan_id,
            'indikator_label'           => $x->indikator_label,
            'subkegiatan_id'            => $x->subkegiatan_id,
            'subkegiatan_label'         => $x->subkegiatan_label,

           
			'realisasi_indikator_id'    => $x->realisasi_indikator_id,
			'realisasi_subkegiatan_id'  => $x->realisasi_subkegiatan_id,
            ...
            'target_quality'            => $x->realisasi_subkegiatan_id ? $x->realisasi_subkegiatan_target_quality : $x->kegiatan_tahunan_quality,
            'target_waktu'              => $x->realisasi_subkegiatan_id ? $x->realisasi_subkegiatan_target_waktu : $x->kegiatan_tahunan_target_waktu,
            'target_cost'               => $x->realisasi_subkegiatan_id ? number_format($x->realisasi_subkegiatan_target_cost,'0',',','.') : number_format($x->kegiatan_tahunan_cost,'0',',','.'),
            'target_ak'                 => $x->realisasi_subkegiatan_id ? $x->realisasi_subkegiatan_target_ak : $x->kegiatan_tahunan_ak,

            'realisasi_ak'              => $x->realisasi_subkegiatan_realisasi_ak,
            'realisasi_quantity'        => $x->realisasi_indikator_realisasi_quantity,
            'realisasi_quality'         => $x->realisasi_subkegiatan_realisasi_quality,
            'realisasi_waktu'           => $x->realisasi_subkegiatan_realisasi_waktu,
            'realisasi_cost'            => number_format($x->realisasi_subkegiatan_realisasi_cost,'0',',','.'),



        ); 
        return $ind_subkegiatan;
    }
    ...
    public function AddRealisasiKegiatanSKPTahunan5(Request $request)
    {
        ...
        $jm_indikator = IndikatorSubKegiatan::WHERE('kegiatan_id',$x->kegiatan_id)->count();
    ...
    public function Store(Request $request)
    {
        ...
        $st_kt    = new RealisasiIndikatorSubKegiatanTahunan;
    ...
    public function Update(Request $request)
    {
        ...
        $st_update                      = RealisasiIndikatorSubKegiatanTahunan::find(Input::get('realisasi_indikator_kegiatan_tahunan_id'));
    ...
    public function Destroy(Request $request)
    {
        ...
        $st_kt    = RealisasiIndikatorSubKegiatanTahunan::find(Input::get('realisasi_indikator_kegiatan_id'));
        if (is_null($st_kt)) {
        ...
        if ( $st_kt->delete()){
            ...
            $data_uing = IndikatorSubKegiatan::WHERE('kegiatan_id',Input::get('kegiatan_id'))
                                            //LEFT JOIN TERHADAP REALISASI INDIKATOR KEGIATAN
