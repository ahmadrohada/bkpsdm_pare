    ...
    protected function kegiatan_triwulan_eselon3($renja_id,$jabatan_id,$capaian_id,$search){
        ...
        $kegiatan = Kegiatan::WHERE('renja_kegiatan.renja_id', $renja_id )
                                ...
                                ->leftjoin('db_pare_2018_demo.renja_indikator_kegiatan AS renja_indikator_kegiatan', function($join){
                                 ...
                                 ->leftjoin('db_pare_2018_demo.realisasi_indikator_kegiatan_triwulan AS realisasi_indikator', function($join) use ( $capaian_id ){
                                ...
                                ->leftjoin('db_pare_2018_demo.realisasi_kegiatan_triwulan AS realisasi_kegiatan', function($join) use ( $capaian_id ){
                                ...
                                ->leftjoin('db_pare_2018_demo.capaian_triwulan AS capaian_triwulan', function($join){
        ...
        protected function kegiatan_triwulan_jft($renja_id,$jabatan_id,$capaian_id,$search){
            ...
            $kegiatan = Sasaran::
                                    ...
                                    //LEFT JOIN TERHADAP REALISASI TAHUNAN tahunan
                                    ->leftjoin('db_pare_2018_demo.realisasi_triwulan_kegiatan_tahunan_jft AS realisasi_kegiatan', function($join) use($capaian_id) {
        ...
        protected function kegiatan_triwulan_jfu($renja_id,$jabatan_id,$capaian_id,$search){
            ...
            $rencana_aksi = RencanaAksi::
                            rightjoin('db_pare_2018_demo.skp_tahunan_kegiatan AS kegiatan_tahunan', function($join){
    ...
    public function Destroy(Request $request)
    {
        ...
        if ( $st_kt->delete()){
            ...
            $data_uing = IndikatorKegiatan::WHERE('kegiatan_id',Input::get('kegiatan_id'))
                                            //LEFT JOIN TERHADAP REALISASI INDIKATOR KEGIATAN
                                            ->join('db_pare_2018_demo.realisasi_indikator_kegiatan_triwulan AS realisasi_indikator', function($join) use($capaian_id) {
                                                $join   ->on('realisasi_indikator.indikator_kegiatan_id','=','renja_indikator_kegiatan.id');
                                                $join   ->WHERE('realisasi_indikator.capaian_id','=',  $capaian_id );
