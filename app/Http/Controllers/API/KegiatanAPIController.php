...
class KegiatanAPIController extends Controller {
    ...
    public function RenjaDistribusiKegiatanTree(Request $request)
    {
        ...
        //KEC Jayakerta
        $s = ['1170','1171','1172','1173','1174'];
        //KEC PAkisjaya
        $t = ['1080','1081','1082','1083','1084'];
        //KEC Cibuaya
        $u = ['1071','1072','1073','1074','1075'];
        //KEC Majalaya
        $v = ['1161','1162','1163','1164','1165'];
        //KEC Batujaya
        $w = ['1044','1045','1046','1047','1048'];
        //KEC Rwamerta
        $x = ['1134','1135','1136','1137','1138'];
        //KEC Cilebar
        $y = ['1262','1263','1264','1265','1266'];
        //KEC tirtajaya
        $z = ['1053','1054','1055','1056','1057'];
        //KEC Rengas dengklok
        $aa = ['1026','1027','1028','1029','1030'];
        //KEC RCilamaya kulon
        $ac = ['1179','1180','1181','1182','1183'];
        //KEC Tempuran
        $ad = ['1152','1153','1154','1155','1156'];
        //KEC telagasari
        $ae = ['1125','1126','1127','1128','1129'];
        ...
        $pengecualian = array_merge($a,$b,$c,$d,$e,$f,$g,$h,$i,$j,$k,$l,$m,$n,$o);
