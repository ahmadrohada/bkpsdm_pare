...
class RealisasiSasaranTahunanAPIController extends Controller {
    ...
    public function RealisasiSasaranTahunan(Request $request) 
    {
        ...
        $dt = Tujuan:: 
                        ...
                        //INDIKATOR SASARAN
                        ->leftjoin('pare_2018_demo.renja_indikator_sasaran AS indikator_sasaran', function($join){
                            $join   ->on('indikator_sasaran.sasaran_id','=','sasaran.id');
                        })
                         
                       
                        //LEFT JOIN TERHADAP REALISASI SASARAN
                        ->leftjoin('pare_2018_demo.realisasi_sasaran_tahunan AS realisasi_sasaran', function($join) use ( $capaian_id ){
                        ...
                        ->leftjoin('pare_2018_demo.realisasi_indikator_sasaran_tahunan AS realisasi_indikator', function($join) use ( $capaian_id ){
    ...
    public function AddRealisasiSasaranTahunan(Request $request)
    {
        ...
        $x = IndikatorSasaran::
                            leftjoin('pare_2018_demo.renja_sasaran AS renja_sasaran', function($join) {
    ...
    public function Destroy(Request $request)
    {
        ...
        if ( $st_kt->delete()){
            ...
            $data_uing = IndikatorSasaran::WHERE('sasaran_id',Input::get('sasaran_id'))
                                            ...
                                            ->join('pare_2018_demo.realisasi_indikator_sasaran_tahunan AS realisasi_indikator', function($join) use($capaian_id) {
                                                $join   ->on('realisasi_indikator.indikator_sasaran_id','=','renja_indikator_sasaran.id');
                                                $join   ->WHERE('realisasi_indikator.capaian_id','=',  $capaian_id );
