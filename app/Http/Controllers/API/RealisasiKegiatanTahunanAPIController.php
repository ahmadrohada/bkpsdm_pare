...
class RealisasiKegiatanTahunanAPIController extends Controller {
    ...
    protected function hitung_quantity($capaian_id,$kegiatan_tahunan_id,$jm_indikator){
        $data_uing = KegiatanSKPTahunan::
                ...
                leftjoin('db_pare_2018_demo.renja_indikator_kegiatan AS renja_indikator_kegiatan', function($join){
                ...
                ->join('db_pare_2018_demo.realisasi_indikator_kegiatan_tahunan AS realisasi_indikator', function($join) use ( $capaian_id ){
    ...
    $kegiatan = Kegiatan::WHERE('renja_kegiatan.renja_id', $renja_id )
                            ...
                            ->leftjoin('db_pare_2018_demo.renja_indikator_kegiatan AS renja_indikator_kegiatan', function($join){
                             ...
                             //LEFT JOIN TERHADAP REALISASI INDIKATOR KEGIATAN
                             ->leftjoin('db_pare_2018_demo.realisasi_indikator_kegiatan_tahunan AS realisasi_indikator', function($join) use ( $capaian_id ){
                                $join   ->on('realisasi_indikator.indikator_kegiatan_id','=','renja_indikator_kegiatan.id');
                                $join   ->WHERE('realisasi_indikator.capaian_id','=',  $capaian_id );
                                
                            })
                            //LEFT JOIN TERHADAP REALISASI TAHUNAN tahunan
                            ->leftjoin('db_pare_2018_demo.realisasi_kegiatan_tahunan AS realisasi_kegiatan', function($join) use ( $capaian_id ){
                            ...
                            ->leftjoin('db_pare_2018_demo.capaian_tahunan AS capaian_tahunan', function($join){
    ...
    protected function kegiatan_tahunan_jft($renja_id,$jabatan_id,$capaian_id,$search){
        ...
        $kegiatan = CapaianTahunan::
                                ...
                                ->leftjoin('db_pare_2018_demo.skp_tahunan AS skp_tahunan', function($join){
                                    $join   ->on('skp_tahunan.id','=','capaian_tahunan.skp_tahunan_id');
                                })
                                ->leftjoin('db_pare_2018_demo.skp_tahunan_kegiatan_jft AS skp_tahunan_kegiatan_jft', function($join){
                                    $join   ->on('skp_tahunan_kegiatan_jft.skp_tahunan_id','=','skp_tahunan.id');
                                })
                                //LEFT JOIN TERHADAP REALISASI TAHUNAN JFT
                                ->leftjoin('db_pare_2018_demo.realisasi_kegiatan_tahunan_jft AS realisasi_kegiatan', function($join) use ( $capaian_id ){
        ...
        public function RealisasiKegiatanTahunan4(Request $request){ 
            ...
            $rencana_aksi = RencanaAksi::WHERE('skp_tahunan_rencana_aksi.jabatan_id',$jabatan_id)
                            ...
                            //LEFT JOIN ke INDIKATOR KEGIATAN
                            ->LEFTJOIN('db_pare_2018_demo.renja_indikator_kegiatan AS indikator_kegiatan', function($join){
    ...
    /* public function RealisasiKegiatanTriwulan2(Request $request) 
    {
       ...
       //KEGIATAN KABID
        ...
        $kegiatan = Kegiatan::WHERE('renja_kegiatan.renja_id', $request->renja_id )
                            ...
                            ->leftjoin('db_pare_2018_demo.realisasi_triwulan_kegiatan_tahunan AS realisasi_triwulan', function($join) use ( $capaian_triwulan_id ){
