...
class PerjanjianKinerjaAPIController extends Controller {
    ...
    public function SasaranStrategisSKPD(Request $request)
    {
        ...
        $dt = Tujuan::
                    rightjoin('pare_2018_demo.renja_sasaran AS sasaran', function ($join) {
    ...
    public function ProgramSKPD(Request $request)
    {
        ...
        $dt = Tujuan::
                    ...
                    ->rightjoin('pare_2018_demo.renja_program AS program', function ($join) {
    ...
    public function cetakPerjanjianKinerjaEsl2(Request $request)
    {
        ...
        $data_2 = Tujuan:: 
                    ...
                    ->leftjoin('pare_2018_demo.renja_kegiatan AS kegiatan', function ($join) {
        ...
        $Renja = Renja::WHERE('renja.id',$renja_id )
                ...
                ->leftjoin('pare_2018_demo.masa_pemerintahan AS masa_pemerintahan', function ($join) {
    ...
    public function SasaranStrategisEselon3(Request $request)
    {
        ...
        $dt = Kegiatan::
                            ...
                            join('pare_2018_demo.renja_program AS program', function($join){
                                $join   ->on('renja_kegiatan.program_id','=','program.id');
                            })
                            ->join('pare_2018_demo.renja_indikator_program AS ind_program', function($join){
    ...
    public function ProgramEselon3(Request $request)
    {
        ...
        $dt = Kegiatan::
                            ...
                            ->rightjoin('pare_2018_demo.renja_indikator_program AS ind_program', function($join){
                                $join   ->on('ind_program.program_id','=','program.id');
    ...
    public function SasaranStrategisEselon4(Request $request)
    {
        ...
        $dt = Kegiatan::
                            ...
                            join('pare_2018_demo.renja_indikator_kegiatan AS indikator_kegiatan', function($join){
    ...
    public function SKPDPerjanjianKinerja_list(Request $request)
    {
        ...
        $dt = \DB::table('pare_2018_demo.renja AS renja')
                    ...
                    ->rightjoin('pare_2018_demo.perjanjian_kinerja AS pk', function($join){
                    ...
                    ->join('pare_2018_demo.periode AS periode', function($join){
                        $join   ->on('periode.id','=','renja.periode_id');
