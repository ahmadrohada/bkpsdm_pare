    ...
    <div class="login-box">
		...
		<div class="login-box-body">
		            ...
		            <div class="col-xs-10 col-xs-offset-1" >
				        <div class="icon-with-message">
					        <div class="welcome-image">
					            {!! HTML::image(Gravatar::get(Lang::get('auth.newUserEmail',['nip' => $nip] )), Lang::get('auth.newUsername',['username' => $username] ), array('class' => 'image-no-drag')) !!}
					        </div>
		    ...
		    <div class="lockscreen-body text-center margin-bottom-2">
				<p>
					{{ Lang::get('auth.sentEmail',['nip' => $nip] ) }}
				</p>
				<p>
