    ...
    <div class="login-box">
		...
		<div class="login-box-body">
		            ...
		            <div class="col-xs-10 col-xs-offset-1" >
				        <div class="icon-with-message">
					        <div class="welcome-image">
					            {!! HTML::image(Gravatar::get(Auth::user()->nip), Auth::user()->name, array('class' => 'image-no-drag')) !!}
					        </div>
		    ...
		    <div class="lockscreen-body text-center margin-bottom-2">
				<p>An nip was sent to on {{ $date }} to</p>
				<h4 class="margin-top-1 margin-bottom-1">{{ $nip }}</h4>
				<p>{{ Lang::get('auth.clickInEmail') }}</p>
		    </div>

	        <hr class="login-full-span">
			<div class="input-group-btn text-center">
				{!! HTML::icon_btn( '/resendEmail', 'fa fa-paper-plane-o margin-left-1', Lang::get('auth.clickHereResend'), array('title' => Lang::get('auth.clickHereResend'), 'class' => 'btn btn-primary  margin-top-1 margin-bottom-1')) !!}
			</div>
