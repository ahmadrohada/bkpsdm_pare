				...
				<div class="nav-tabs-custom">
					...
					<div class="tab-content"  style="margin-left:20px;">
						...
						<div class=" tab-pane fade" id="rencana_kerja_tab">
							@include('pare_2021.modules.tab.pohon_kinerja_edit')
						</div>
						<div class=" tab-pane fade" id="distribusi_kegiatan">
							@include('pare_2021.modules.tab.distribusi_kegiatan_edit') 
						</div>
						<div class=" tab-pane fade" id="perjanjian_kinerja">
							@include('pare_2021.modules.tab.perjanjian_kinerja_skpd_edit') 
						</div>
