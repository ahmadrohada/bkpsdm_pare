			...
			<div class="modal-body">
					...
					<div class="row" style="margin-top:10px;"> 
						...
						<div class="col-md-6 col-xs-6 form-group quantity">	
							...
							<div class="input-group">
								<input type="text" name="realisasi_quantity" onkeypress='return format_quantity(event)' required class="form-control input-sm realisasi_quantity" placeholder="huruf capital / angka">
								<div class="input-group-addon">
									<span class="satuan"></span>
								</div>
							</div>
