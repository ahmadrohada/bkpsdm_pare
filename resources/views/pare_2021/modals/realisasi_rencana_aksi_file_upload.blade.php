        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    Bukti Realisasi Rencana Aksi
                </h4>
            </div>

            <form  id="bukti_realisasi_form" method="POST" action="" enctype="multipart/form-data">
			<input type="hidden"  name="realisasi_rencana_aksi_id" class="form-control realisasi_rencana_aksi_id">
...
<script type="text/javascript">
	...
	function update_table(bukti){
		...
		$.ajax({
			url		: '{{ url("api_resource/update_bukti_realisasi_rencana_aksi_3") }}',
			type	: 'POST',
			data	:  data,
