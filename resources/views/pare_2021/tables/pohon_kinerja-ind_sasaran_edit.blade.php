...
<div class="box box-sasaran div_ind_sasaran_list" hidden>
	...
	<div class="box-body table-responsive">
		...
		<div class="toolbar">
			...
			<span  data-toggle="tooltip" title="Create Indikator Program"><a class="btn btn-info btn-xs create_ind_sasaran" ><i class="fa fa-plus" ></i> Indikator Program</a></span>
...
@include('pare_2021.modals.renja_ind_sasaran')
...
$('#ind_sasaran_table').DataTable({
	...
	$(document).on('click','.create_ind_sasaran',function(e){
		$('.modal-ind_sasaran').find('h4').html('Create Indikator Program');
	...
	$(document).on('click','.edit_ind_sasaran',function(e){
		...
		$.ajax({
				...
				success	: function(data) {
					...
					$('.modal-ind_sasaran').find('h4').html('Edit Indikator Program');
