...
<div class="box box-tujuan div_tujuan_list">
    <div class="box-header with-border">
		<h1 class="box-title">
            Bidang Urusan ( {{ $renja->Periode->label}} )
        </h1>
	...
	<div class="box-body table-responsive">
		...
		<div class="toolbar">
			...
			<span  data-toggle="tooltip" title="Create Bidang Urusan"><a class="btn btn-info btn-xs create_tujuan" ><i class="fa fa-plus" ></i> Bidang Urusan</a></span>
...
@include('pare_2021.modals.renja_tujuan')
...
<script type="text/javascript">
	...
	$(document).on('click','.create_tujuan',function(e){
		$('.modal-tujuan').find('h4').html('Create Bidang Urusan');
