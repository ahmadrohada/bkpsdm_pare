...
<div class="box box-tujuan div_ind_tujuan_list" hidden>
	...
	<div class="box-body table-responsive">
		...
		<div class="toolbar">
			<span  data-toggle="tooltip" title="Create Indikator Bidang Urusan"><a class="btn btn-info btn-xs create_ind_tujuan" ><i class="fa fa-plus" ></i> Indikator Bidang Urusan</a></span>
		</div>
...
@include('pare_2021.modals.renja_ind_tujuan')
...
function load_ind_tujuan(tujuan_id){
	...
	$(document).on('click','.create_ind_tujuan',function(e){
		$('.modal-ind_tujuan').find('h4').html('Create Indikator Bidang Urusan');
	...
	$(document).on('click','.edit_ind_tujuan',function(e){
		...
		$.ajax({
				...
				success	: function(data) {
					...
					$('.modal-ind_tujuan').find('h4').html('Edit Indikator Bidang Urusan');
	...
	$(document).on('click','.hapus_ind_tujuan',function(e){
		...
		Swal.fire({
			title: "Hapus  Indikator Bidang Urusan",
