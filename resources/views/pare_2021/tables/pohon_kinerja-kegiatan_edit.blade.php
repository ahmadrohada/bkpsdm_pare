...
<div class="box box-kegiatan div_kegiatan_list" hidden>
	...
	<div class="box-body table-responsive">
		<div class="toolbar">
			<span  data-toggle="tooltip" title="Create Sub  Kegiatan"><a class="btn btn-info btn-xs create_kegiatan" ><i class="fa fa-plus" ></i> Sub  Kegiatan</a></span>
		</div>
		...
		<table id="kegiatan_table_non_anggaran" class="table table-striped table-hover table-condensed" >
			<thead>
				<tr class="success">
					<th>NO</th>
					<th >LABEL / SUB KEGIATAN NON ANGGARAN</th>
					<th><i class="fa fa-cog"></i></th>
				</tr>
			</thead>
...
function load_kegiatan(program_id){
	...
	$(document).on('click','.create_kegiatan',function(e){
		$('.modal-kegiatan').find('h4').html('Create Sub Kegiatan');
	...
	$(document).on('click','.edit_kegiatan',function(e){
		...
		$.ajax({
				...
				success	: function(data) {
					...
					$('.modal-kegiatan').find('h4').html('Edit Sub Kegiatan');
