		...
		<div class="box box-default">
			<div class="box-body box-profile">
				...
				<ul class="list-group list-group-unbordered">
					...
					<li class="list-group-item hidden">
						Capaian Kinerja tahunan <span class="text-muted"> (bobot 70%)</span><a class="pull-right st_capaian_kinerja_tahunan" >-</a>
					</li>
					...
					<li class="list-group-item st_pke hidden" style="background:#efeff0; border-top: solid #615e68 !important; border-top-width: 2px;">
						<strong>Capaian SKP tahunan</strong> <a class="pull-right st_capaian_skp_tahunan" style="font-weight: bold;" >-</a>
					</li>
