...
<div class="row">
	...
	<div class="right_div col-md-6">
		@include('pare_2021.tables.pohon_kinerja-tujuan_edit')
		@include('pare_2021.tables.pohon_kinerja-ind_tujuan_edit')
		@include('pare_2021.tables.pohon_kinerja-sasaran_edit')
		@include('pare_2021.tables.pohon_kinerja-ind_sasaran_edit')
		@include('pare_2021.tables.pohon_kinerja-program_edit')
		@include('pare_2021.tables.pohon_kinerja-ind_program_edit')
		@include('pare_2021.tables.pohon_kinerja-kegiatan_edit')
		@include('pare_2021.tables.pohon_kinerja-ind_kegiatan_edit')
		@include('pare_2021.tables.pohon_kinerja-ind_kegiatan2_edit')
...
<script type="text/javascript">
	...
	function renja_list_kegiatan_tree() {
		...
		$('#renja_tree_kegiatan').jstree({
			'core' : {
				'data' : {
					'url' : "{{ url("api_resource/skpd_pohon_kinerja_2021") }}",   
					'data' : function (node) {
						return { 	"id" 		: node.id ,
									"data" 		: node.data,
									"renja_id" 	: {!! $renja->id !!}
