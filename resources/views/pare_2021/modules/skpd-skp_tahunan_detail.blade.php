...
<div class="row">
		...
		<div class="form-horizontal col-md-6" style="margin-top:20px;">
			...
			<div class="form-group form-group-sm"  style="margin-top:10px !important;">
				<label class="col-md-4">NIP</label>
				<div class="col-md-8">
					<span class="form-control">{{ $skp->PegawaiYangDinilai->nip }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				<label class="col-md-4 " >Pangkat / Gol</label>
				<div class="col-md-8">
					<span class="form-control">{{ ( $skp->PegawaiYangDinilai->golongan ? $skp->PegawaiYangDinilai->golongan->pangkat : '' ) }} /  {{ ( $skp->PejabatPenilai->golongan ? $skp->PejabatPenilai->golongan->golongan : '' ) }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				<label class="col-md-4 " >Eselon</label>
				<div class="col-md-8">
					<span class="form-control">{{ ( $skp->PegawaiYangDinilai->eselon ? $skp->PegawaiYangDinilai->eselon->eselon : '' ) }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				<label class="col-md-4 ">Jabatan</label>
				<div class="col-md-8">
					<span class="form-control" style="height:48px;">{{  pustaka::capital_string( ( $skp->PegawaiYangDinilai->Jabatan ? $skp->PegawaiYangDinilai->Jabatan->skpd : '' )) }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				<label class="col-md-4">Unit Kerja</label>
				<div class="col-md-8">
					<span class="form-control" style="height:60px;">{{ pustaka::capital_string( ( $skp->PegawaiYangDinilai->skpd ? $skp->PegawaiYangDinilai->skpd->skpd : '' )) }}</span>
				</div>
			</div>
		</div>	  
</div>
