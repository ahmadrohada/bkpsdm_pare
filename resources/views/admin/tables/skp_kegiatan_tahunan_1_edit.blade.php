...
<div class="row">
	...
	<div class="col-md-7">
        ...
        <div id='detail_kegiatan_renja' hidden>
			<div class="box box-primary">
				<div class="box-header with-border">
					<h1 class="box-title">
						Detail Kegiatan Renja
					</h1>
				...
				<div class="box-body table-responsive">
					...
					<strong>Nama Kegiatan Tahunan</strong>
					<p class="text-danger " style="margin-top:8px;padding-bottom:10px;">
						<span class="kegiatan_tahunan_label"></span>
						<input type="hidden" class="kegiatan_tahunan_id">
					</p>
...
<script type="text/javascript">
	...
	function initTree() {
		...
		.jstree({
            'core' : {
				'data' : {
						"url" 	: "{{ url("api_resource/skp_tahunan_kegiatan_1") }}", //Eselon 2
						"data" 	: function (node) {
	...
	function detail_table(id){
		...
		switch ( tx[0] ){
                ...
                case 'KegiatanRenja':
                            ...
                            $("#kegiatan_tahunan").hide();
                            $("#rencana_aksi").hide();
                            $("#detail_kegiatan_renja").show();
                            
                            detail_kegiatan_renja( tx[1]);
