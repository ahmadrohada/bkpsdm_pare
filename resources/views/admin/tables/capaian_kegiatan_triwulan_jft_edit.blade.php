...
<!--====================== KEGIATAN BULANAN LIST =========================================== -->
		<div class="box box-primary" id='kegiatan_triwulan'>
			<div class="box-header with-border">
				<h1 class="box-title">
					List Realisasi Kegiatan Tahunan Trimester {!! $capaian_triwulan->trimester !!} [ Eselon {!! $capaian_triwulan->PejabatYangDinilai->Eselon->eselon !!}  ]
				</h1>
...
<script type="text/javascript">
									...
									{  data: 'action',width:"60px",
											...
											if ( {!! $capaian_triwulan->status !!} == 1 ){
												...
												if ( (row.realisasi_kegiatan_id) >= 1 ){
													...
													return  '<span  data-toggle="tooltip" title="Add" style="margin:2px;" ><a class="btn btn-info btn-xs create_realisasi_triwulan"  data-kegiatan_tahunan_id="'+row.kegiatan_tahunan_id+'" data-kegiatan_tahunan_id="'+row.kegiatan_tahunan_id+'"><i class="fa fa-plus" ></i></a></span>'+
	...
	function show_modal_create(kegiatan_tahunan_id){
		$.ajax({
				url			  	: '{{ url("api_resource/add_realisasi_kegiatan_triwulan_jft") }}',
				data 		  	: { 
									kegiatan_tahunan_id : kegiatan_tahunan_id ,
	...
	$(document).on('click','.edit_realisasi_triwulan',function(e){
		...
		$('.modal-realisasi_tahunan').find('h4').html('Edit Realisasi Kegiatan Tahunan Trimester '+ {!! $capaian_triwulan->trimester !!});
