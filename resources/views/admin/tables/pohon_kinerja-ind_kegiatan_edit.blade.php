...
<div class="box box-indikator_kegiatan div_ind_kegiatan_list" hidden>
	...
	<div class="box-body table-responsive">
		...
		<div class="toolbar">
			...
			<span  data-toggle="tooltip" title="Create Indikator kegiatan"><a class="btn btn-info btn-sm create_ind_kegiatan" ><i class="fa fa-plus" ></i> Indikator Kegiatan</a></span>
...
@include('admin.modals.renja_ind_kegiatan')
