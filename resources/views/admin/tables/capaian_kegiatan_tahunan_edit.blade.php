...
<!--====================== KEGIATAN BULANAN LIST =========================================== -->
		<div class="box box-primary" id='kegiatan_tahunan'>
			...
			<div class="box-body table-responsive">
				...
				<table id="realisasi_kegiatan_tahunan_table" class="table table-striped table-hover display nowrap" style="width:100%">
					<thead>
						<tr>
							<th rowspan="2">No</th>
...
@include('admin.modals.realisasi_kegiatan_tahunan')
...
<script type="text/javascript">
  	...
  	function load_kegiatan_tahunan(){
		...
		var table_kegiatan_tahunan = $('#realisasi_kegiatan_tahunan_table').DataTable({
				...
				//order 			: [0 , 'asc' ],
				columnDefs		: [
									{ "orderable": false, className: "text-center", targets: [ 0,3,4,5,7,8,9,11,12,13,14,15,16 ] },
