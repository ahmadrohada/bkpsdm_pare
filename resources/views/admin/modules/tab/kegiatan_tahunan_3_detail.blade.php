...
<div class="row">
	...
	<div class="col-md-7">
		@include('admin.tables.skp_tahunan-kegiatan_3_detail')
		@include('admin.tables.skp_tahunan-indikator_kegiatan_3_detail')
		@include('admin.tables.skp_tahunan-rencana_aksi_3_detail')
