<div class="row">
	...
	<div class="col-md-7">
		@include('admin.tables.renja-tujuan_detail')
		@include('admin.tables.renja-ind_tujuan_detail')
		@include('admin.tables.renja-sasaran_detail')
		@include('admin.tables.renja-ind_sasaran_detail')
		@include('admin.tables.renja-program_detail')
		@include('admin.tables.renja-ind_program_detail')
		@include('admin.tables.renja-kegiatan_detail')
		@include('admin.tables.renja-ind_kegiatan_detail')
