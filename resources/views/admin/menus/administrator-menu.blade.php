...
<li>
    {!! HTML::icon_link( "admin/tpp_report", 'fa '.Lang::get('sidebar-nav.link_icon_report'), "<span>".Lang::get('sidebar-nav.link_title_report')."</span>", array('title' => Lang::get('sidebar-nav.link_title_report'))) !!}
</li>
