...
<li>
    {!! HTML::icon_link( "admin/users", 'fa '.Lang::get('sidebar-nav.link_icon_users_view'), "<span>".Lang::get('sidebar-nav.link_title_users_view')."</span>", array('title' => Lang::get('sidebar-nav.link_title_users_view'))) !!}
</li>
