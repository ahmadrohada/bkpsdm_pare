                                    ...
                                    <tr>
                                        <td width="100%" valign="top" bgcolor="#e7e7e7">
                                            ...
                                            <div id="synopsis" style="display: none; font-size: 1px; color: #e7e7e7; line-height: 1px; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
                                                {{ Lang::get('nips.nipResetPwSynapsis') }}
                                            </div>
                                            <!-- END PREFACE -->
                                            <!-- START SEPERATOR -->
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" align="left" bgcolor="#ffffff" style="width: 580px;" class="device-width">
                                                            <tr>
                                                                <td align="left" valign="top" bgcolor="#ffffff" style="padding: 25px 25px 25px 25px;" class="heading-hello">
                                                                    <font color="#525252">
                                                                        {{ Lang::get('nips.nipResetPwSalutation') }}
                                                                    </font>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="left" bgcolor="#ffffff" style="padding: 0 25px 30px 25px;" class="body-text">
                                                                    <p style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 16px;line-height: 22px;text-decoration: none;font-weight: 400;">
                                                                        {{ Lang::get('nips.nipResetPwMessage') }}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                                                                        ...
                                                                                                                        <!--[if mso]>
                                                                                                                            ...
                                                                                                                            <w:anchorlock/>
                                                                                                                                <center style="color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;">
                                                                                                                                    {{ Lang::get('nips.nipsClickHereResetBTN') }}
                                                                                                                                </center>
                                                                                                                            </v:roundrect>
                                                                                                                        <![endif]-->
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#ffffff" style="padding: 8px 25px 10px 25px;" class="body-text">
                                                        <p class="footer-text" style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 14px !important;line-height: 1.3 !important;text-decoration: none;font-weight: 400;text-align:center;">
                                                            {{ Lang::get('nips.nipResetPwFooter') }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
