<div class="row">
		<div class="form-horizontal col-md-6" style="margin-top:5px;">
			...
			<div class="form-group form-group-sm" style="margin-top:10px;">
				...
				<div class="col-md-8">
					<span id="date_created" class="form-control">{{ $pk->renja->created_at }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				...
				<div class="col-md-8">
					<span id="periode" class="form-control"> {{ $pk->renja->periode->label }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				...
				<div class="col-md-8">
					<span class="form-control" style="height:60px;">{{ Pustaka::capital_string($pk->renja->skpd->skpd) }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				...
				<div class="col-md-8">
					<span class="form-control">{{ $pk->renja->nama_kepala_skpd }}</span>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="margin-top:-10px;">
				...
				<div class="col-md-8">
					<span class="form-control">{{ $pk->renja->nama_admin_skpd }}</span>
				</div>
			</div>
