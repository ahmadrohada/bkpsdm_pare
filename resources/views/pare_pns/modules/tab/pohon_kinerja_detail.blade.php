...
<div class="row">
	...
	<div class="right_div col-md-6">
		@include('pare_pns.tables.pohon_kinerja-tujuan_detail')
		@include('pare_pns.tables.pohon_kinerja-ind_tujuan_detail')
		@include('pare_pns.tables.pohon_kinerja-sasaran_detail')
		@include('pare_pns.tables.pohon_kinerja-ind_sasaran_detail')
		@include('pare_pns.tables.pohon_kinerja-program_detail')
		@include('pare_pns.tables.pohon_kinerja-ind_program_detail')
		@include('pare_pns.tables.pohon_kinerja-kegiatan_detail')
		@include('pare_pns.tables.pohon_kinerja-ind_kegiatan_detail')
		@include('pare_pns.tables.pohon_kinerja-ind_kegiatan2_edit')
