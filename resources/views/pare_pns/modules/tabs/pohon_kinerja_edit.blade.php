...
<div class="row">
	...
	<div class="right_div col-md-6">
		@include('pare_pns.tables.pohon_kinerja-tujuan_edit')
		@include('pare_pns.tables.pohon_kinerja-ind_tujuan_edit')
		@include('pare_pns.tables.pohon_kinerja-sasaran_edit')
		@include('pare_pns.tables.pohon_kinerja-ind_sasaran_edit')
		@include('pare_pns.tables.pohon_kinerja-program_edit')
		@include('pare_pns.tables.pohon_kinerja-ind_program_edit')
		@include('pare_pns.tables.pohon_kinerja-kegiatan_edit')
		@include('pare_pns.tables.pohon_kinerja-ind_kegiatan_edit')
