        ...
        <div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<input type="text" name="target_ind_kegiatan" id="target_ind_kegiatan" onkeypress='return format_quantity(event)' required class="form-control input-sm" placeholder="target">        
						</div>
