        ...
        <div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<input type="text" name="target_ind_program" id="target_ind_program" required class="form-control input-sm" onkeypress='return format_quantity(event)' placeholder="">        
						</div>
...
<script type="text/javascript">
	...
	$('.modal-ind_program').on('shown.bs.modal', function(){
		$(this).find('.label_ind_program').focus();
	});
	...
	$(document).on('click','#submit-save-ind_program',function(e){
		...
		//alert(data);
		$.ajax({
			url		: '{{ url("api/simpan_ind_program") }}',
			type	: 'POST',
			data	:  data,
	...
	$(document).on('click','#submit-update-ind_program',function(e){
		...
		//alert(data);
		$.ajax({
			url		: '{{ url("api/update_ind_program") }}',
			type	: 'POST',
			data	:  data,
			success	: function(data , textStatus, jqXHR) {
