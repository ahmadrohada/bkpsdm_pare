<div class="modal fade modal-kreativitas" id="" role="dialog"  aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form  id="kreativitas-form" method="POST" action="">
                        ...
                        <div class="modal-footer">
                            ...
                            {!! Form::button('<i class="fa fa-fw '.Lang::get('modals.confirm_modal_button_save_icon').'" aria-hidden="true"></i> ' . Lang::get('modals.confirm_modal_button_save_text'), array('class' => 'btn btn-sm btn-primary pull-right ', 'type' => 'button', 'id' => 'simpan_kegiatan' )) !!}
                        </div>
...
$(document).ready(function() {
	...
	$('.kreativitas_modal').on('hidden.bs.modal', function(){
		$('.txt-kegiatan').html('');
    ...
    $(document).on('click', '#simpan_kreativitas', function(){
		
        var data = $('#kreativitas-form').serialize();
		$.ajax({
