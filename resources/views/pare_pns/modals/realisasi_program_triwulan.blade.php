					...
					<div class="row" style="margin-top:-20px;"> 
						...
						<div class="col-md-6 col-xs-6 form-group cost cost">	
							...
							<div class="input-group">
								...
								<input type="text" name="realisasi_cost" id="rupiah" required class=" form-control input-sm realisasi_cost" placeholder="cost realisasi">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	...
	$('.modal-realisasi_program_triwulan').on('hidden.bs.modal', function(){
		...
		$('.modal-realisasi_program_triwulan').find('[name=realisasi_quantity],[name=realisasi_quality],[name=realisasi_cost]').val('');
	});
