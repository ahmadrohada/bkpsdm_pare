        ...
        <div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<input type="text" name="target_ind_tujuan" id="target_ind_tujuan" required class="form-control input-sm" onkeypress='return format_quantity(event)' placeholder="1234567890ABCDE">        
						</div>
