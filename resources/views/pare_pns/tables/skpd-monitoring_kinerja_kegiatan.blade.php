<div class="box-body table-responsive" style="">
				...
				<table id="table_monitoring_kinerja_kegiatan" class="table table-striped table-hover " style="font-size:83% ;">
					<thead> 
						<tr>
						...
						<tr>
							<th style="padding-left:4px; padding-right:4px ;">TARGET</th>
