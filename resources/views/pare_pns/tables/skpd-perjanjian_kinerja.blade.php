...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#rkpd_table').DataTable({
				...
				ajax			: {
									url	: '{{ url("api_resource/skpd_perjanjian_kinerja_list") }}',
				...
				columns	:[
								...
								{ data: "status" , orderable: false,searchable:false,width:"50px",
										...
										if ( row.status == 1){
											...
											return  '<span  data-toggle="tooltip" title="Edit" style="margin:1px;" class=""><a href="{{ url('skpd/perjanjian_kinerja') }}/'+row.pk_id+'" class="btn btn-xs btn-info"><i class="fa fa-edit"></i></a></span>';
