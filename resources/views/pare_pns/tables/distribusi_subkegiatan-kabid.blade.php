<div class="box box-warning div_kabid" hidden>
	...
	<div class="box-body table-responsive">
		...
		<table id="subkegiatan_kabid_table" class="table table-striped table-hover table-condensed" >
			<thead>
				<tr class="success">
					<th>NO</th>
					<th >SUB KEGIATAN</th>
...
load_subkegiatan_kabid({!!$renja->KepalaSKPD->id_jabatan!!});

function load_subkegiatan_kabid(jabatan_id){
    ...
    $('#subkegiatan_kabid_table').DataTable({
				destroy			: true,
				processing      : false,
				serverSide      : true,
				autoWidth		: false,
				...
				ajax			: {
									url	: '{{ url("api/skpd-renja_subkegiatan_list_kabid") }}',
									data: { jabatan_id: jabatan_id ,
											renja_id:{!! $renja->id !!}
										},
								}, 
