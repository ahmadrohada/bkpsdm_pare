...
{{-- -or- {!! Form::open(array('url' => url('/users'), 'method' => 'POST', 'method' => 'POST', 'role' => 'form')) !!} --}}
	...
	<div class="form-group has-feedback">
		{!! Form::label('nip', Lang::get('forms.create_user_label_nip'), array('class' => 'col-md-3 control-label margin-bottom-half')); !!}
      	<div class="input-group">
        	{!! Form::text('nip', NULL, array('id' => 'nip', 'class' => 'form-control', 'placeholder' => Lang::get('forms.create_user_ph_nip'))) !!}
        	<label class="input-group-addon" for="nip"><i class="fa fa-fw {{ Lang::get('forms.create_user_icon_nip') }}" aria-hidden="true"></i></label>
      	</div>
	</div>
	...
	<div class="form-group has-feedback">
		{!! Form::label('first_name', Lang::get('forms.create_user_label_nip'), array('class' => 'col-md-3 control-label margin-bottom-half')); !!}
      	<div class="input-group">
        	{!! Form::text('first_name', NULL, array('id' => 'first_name', 'class' => 'form-control', 'placeholder' => Lang::get('forms.create_user_ph_nip'))) !!}
        	<label class="input-group-addon" for="first_name"><i class="fa fa-fw {{ Lang::get('forms.create_user_icon_nip') }}" aria-hidden="true"></i></label>
      	</div>
	</div>

	<div class="form-group has-feedback">
		{!! Form::label('last_name', Lang::get('forms.create_user_label_nip'), array('class' => 'col-md-3 control-label margin-bottom-half')); !!}
      	<div class="input-group">
        	{!! Form::text('last_name', NULL, array('id' => 'last_name', 'class' => 'form-control', 'placeholder' => Lang::get('forms.create_user_ph_nip'))) !!}
        	<label class="input-group-addon" for="last_name"><i class="fa fa-fw {{ Lang::get('forms.create_user_icon_nip') }}" aria-hidden="true"></i></label>
      	</div>
	</div>
